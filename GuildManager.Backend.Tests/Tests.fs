...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> GuildManager.Backend.App.configApp)
        .ConfigureServices(Action<IServiceCollection> GuildManager.Backend.App.configServices)
